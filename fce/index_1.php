...
<div id="panel">
<div id="loginbox"><form method="post" action="includes/login.php" class="para">
...
<div id="evalbox"><form method="post" name="" class="para" action="includes/evaluate.php">
                        <p></p>
                        <input type="text" name='key_value' placeholder=" Access Key" class="round down" required pattern=".{5,5}" title="Exactly 5 characters" maxlength='5'><br>
                        <br><br><p></p>
